...
void TableData::addColumn(Transaction* transaction, const std::string& colNamePrefix,
    ...
    auto column =
        ColumnFactory::createColumn(colName, *property.getDataType()->copy(), metadataDAHInfo,
            dataFH, *metadataDAC, bufferManager, wal, transaction, enableCompression, readOnly);
