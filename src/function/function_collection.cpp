...
#define SCALAR_FUNCTION_ALIAS2(_PARAM)                                                             \
    { _PARAM::getFunctionSet, _PARAM::alias2, CatalogEntryType::SCALAR_FUNCTION_ENTRY }
...
FunctionCollection* FunctionCollection::getFunctions() {
    static FunctionCollection functions[] = {
        ...
        SCALAR_FUNCTION(LowerFunction), SCALAR_FUNCTION_ALIAS(LowerFunction),
        ...
        SCALAR_FUNCTION_ALIAS2(UpperFunction), SCALAR_FUNCTION(RegexpFullMatchFunction),
        ...
        SCALAR_FUNCTION(LevenshteinFunction), SCALAR_FUNCTION(InitcapFunction),
        ...
        SCALAR_FUNCTION(ListAppendFunction), SCALAR_FUNCTION_ALIAS(ListAppendFunction),
        SCALAR_FUNCTION(ArrayAppendFunction), SCALAR_FUNCTION_ALIAS(ArrayAppendFunction),
        SCALAR_FUNCTION(ListPrependFunction), SCALAR_FUNCTION(ArrayPrependFunction),
        SCALAR_FUNCTION_ALIAS(ArrayPrependFunction), SCALAR_FUNCTION(ListPositionFunction),
        SCALAR_FUNCTION_ALIAS(ListPositionFunction), SCALAR_FUNCTION(ArrayPositionFunction),
        SCALAR_FUNCTION_ALIAS(ArrayPositionFunction), SCALAR_FUNCTION(ListContainsFunction),
        SCALAR_FUNCTION_ALIAS(ListContainsFunction), SCALAR_FUNCTION(ArrayContainsFunction),
        SCALAR_FUNCTION_ALIAS(ArrayContainsFunction), SCALAR_FUNCTION(ListSliceFunction),
        SCALAR_FUNCTION(ArraySliceFunction), SCALAR_FUNCTION(ListSortFunction),
        SCALAR_FUNCTION_ALIAS(ListSortFunction), SCALAR_FUNCTION(ListReverseSortFunction),
        ...
        SCALAR_FUNCTION_ALIAS(CastToStringFunction), SCALAR_FUNCTION_ALIAS2(CastToStringFunction),
        SCALAR_FUNCTION(CastToBlobFunction), SCALAR_FUNCTION_ALIAS(CastToBlobFunction),
        SCALAR_FUNCTION(CastToUUIDFunction), SCALAR_FUNCTION_ALIAS(CastToUUIDFunction),
        SCALAR_FUNCTION(CastToDoubleFunction), SCALAR_FUNCTION_ALIAS(CastToDoubleFunction),
        SCALAR_FUNCTION(CastToFloatFunction), SCALAR_FUNCTION_ALIAS(CastToFloatFunction),
        SCALAR_FUNCTION(CastToSerialFunction), SCALAR_FUNCTION(CastToInt64Function),
        SCALAR_FUNCTION_ALIAS(CastToInt64Function), SCALAR_FUNCTION(CastToInt32Function),
        SCALAR_FUNCTION_ALIAS(CastToInt32Function), SCALAR_FUNCTION(CastToInt16Function),
        ...
        SCALAR_FUNCTION(CastToBoolFunction), SCALAR_FUNCTION_ALIAS(CastToBoolFunction),
        SCALAR_FUNCTION(CastAnyFunction), SCALAR_FUNCTION_ALIAS(CastToTimestampFunction),
