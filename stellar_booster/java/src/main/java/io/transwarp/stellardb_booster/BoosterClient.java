...
public class BoosterClient {
  ...
  private BoosterClient(String graphName, boolean readOnly) {
    ...
    this.database = new BoosterDatabase(path + "/" + graphName, poolSize, enableCompression, readOnly, 0L);
  }
  ...
  public BoosterConnection createConnection() {
    assertDB();
    return new BoosterConnection(database);
  }
