...
Java_io_transwarp_stellardb_1booster_BoosterNative_connection_1set_1max_1num_1thread_1for_1exec(
...
Java_io_transwarp_stellardb_1booster_BoosterNative_connection_1get_1max_1num_1thread_1for_1exec(
    JNIEnv* env, jclass, jobject thisConn) {
    Connection* conn = getConnection(env, thisConn);
...
Java_io_transwarp_stellardb_1booster_BoosterNative_prepared_1statement_1allow_1active_1transaction(
    JNIEnv* env, jclass, jobject thisPS) {
    PreparedStatement* ps = getPreparedStatement(env, thisPS);
...
JNIEXPORT jlong JNICALL
Java_io_transwarp_stellardb_1booster_BoosterNative_data_1type_1get_1fixed_1num_1elements_1in_1list(
    JNIEnv* env, jclass, jobject thisDT) {
    auto* dt = getDataType(env, thisDT);
